    ...
    <div className='bg-[#f8fafc]'>
      ...
      >
        <div className='w-full z-10'>
          ...
          <div className='w-full flex items-center justify-around bg-[#f4f4f5] px-2 md:px-5 py-2.5 md:py-6 shadow-2xl rounded-full'>
            <SearchInput
        ...
        <div className='w-1/3 h-full absolute top-24 md:-top-6 lg:-top-14 right-18 2xl:right-[18rem]'>
